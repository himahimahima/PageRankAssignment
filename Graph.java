...
public class Graph {
	...
	public void setUndirected(Vector<Edge> eList) {
		...
		while (eIt.hasNext()) {
			Edge curEdge = eIt.next();
			eList2.add(new Edge(curEdge.getSecond(), curEdge.getFirst(), curEdge.getWeight()));
		}	
	...
	public void setDefault () {
		// A sample undirected graph used in mixed class questions
	...
	public void setDefaultDir () {
		// A sample directed graph used in mixed class questions
		Vector<Edge> eList = new Vector<Edge>();
	...
	public Vector<Edge> readUnweightedFromFile(String fInName) throws IOException {
	...
	public Vector<Edge> readWeightedFromFile(String fInName) throws IOException {
		// Reads list of edges from a file, one pair of integers per line 
		BufferedReader fIn = new BufferedReader(
							 new FileReader(fInName));
		String s;
	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			...
			g.print();
			System.out.println("The random value is " +g.getVertex(4).getRandomLink());
		}
		catch (IOException e) {
